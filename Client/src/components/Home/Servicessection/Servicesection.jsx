    ...
    <div className="container flex my-16 p-4 w-full mx-auto justify-center ">
      <div className=" flex items-center space-x-16	">
        <div className="flex space-x-8 ">
          <FaShuttleVan className="text-6xl text-[#ca1515] dark:text-white" />
          <div>
        ...
        <div className="flex space-x-8 ">
          <FaRegMoneyBillAlt className="text-6xl text-[#ca1515] dark:text-white" />
          <div>
        ...
        <div className="flex space-x-8 ">
          <MdOutlineSecurity className="text-6xl text-[#ca1515] dark:text-white" />
          <div>
            {" "}
        ...
        <div className="flex space-x-8 ">
          <MdOutlineSupportAgent className="text-6xl text-[#ca1515] dark:text-white" />
          <div>
            {" "}
